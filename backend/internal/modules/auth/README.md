...
`GOOGLE_CLIENT_ID/SECRET/REDIRECT_URL`, `ALLOWED_EMAIL_DOMAIN`, `JWT_ACCESS_SECRET`, `ACCESS_TOKEN_TTL_MINUTES=60`, `REFRESH_TOKEN_TTL_HOURS=72` (3 hari + sliding), `FRONTEND_URL`.
