        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-6 rounded-2xl bg-white border border-black/5 space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="px-2.5 py-1 bg-[#60A8F8]/10 rounded-full text-xs font-medium text-black/60">Next.js</span>
              <span className="px-2.5 py-1 bg-[#60A8F8]/10 rounded-full text-xs font-medium text-black/60">Prisma</span>
              <span className="px-2.5 py-1 bg-[#60A8F8]/10 rounded-full text-xs font-medium text-black/60">TypeScript</span>
            </div>
          </div>
          <div className="p-6 rounded-2xl bg-white border border-black/5 space-y-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <span className="px-2.5 py-1 bg-[#60A8F8]/10 rounded-full text-xs font-medium text-black/60">Figma</span>
              <span className="px-2.5 py-1 bg-[#60A8F8]/10 rounded-full text-xs font-medium text-black/60">Branding</span>
              <span className="px-2.5 py-1 bg-[#60A8F8]/10 rounded-full text-xs font-medium text-black/60">Animation</span>
            </div>
          </div>
        </div>

        <div className="bg-[#0059D0] rounded-2xl p-8 text-center space-y-3">
          ...
          <a href="mailto:careers@ressist.com" className="inline-flex h-10 px-6 bg-white text-[#0059D0] rounded-full text-sm font-medium items-center">
            Kirim Portofolio
          </a>
        </div>
      </div>
