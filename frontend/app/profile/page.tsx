      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
            ...
            <div className="md:ml-auto">
              <button 
                onClick={() => router.push('/dashboard?tab=general')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div 
            ...
            className="space-y-6"
          >
            <h3 className="text-xl font-black text-slate-900 pl-2">Informasi Akun</h3>
            <div className="bg-white border border-slate-100 rounded-[2rem] p-6 space-y-6 shadow-sm">
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Berabung Sejak</p>
                    <p className="font-bold text-slate-900">
                      {userData ? new Date(userData.created_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) : '-'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Verifikasi</p>
                    <p className="font-bold text-slate-900">Siakad Cloud Sync</p>
                  </div>
                </div>
          ...
          <motion.div 
            ...
            className="space-y-6"
          >
            <h3 className="text-xl font-black text-slate-900 pl-2">Status Layanan</h3>
            <div className="bg-white border border-slate-100 rounded-[2rem] p-4 space-y-3 shadow-sm">
              {connections.map((conn, i) => (
                <div key={i} className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl border border-slate-100 group hover:border-blue-200 transition-colors">
                  <div className="flex items-center gap-4">
                    <div className={cn("size-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform", conn.bg, conn.color)}>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left space-y-4">
              <h3 className="text-3xl font-black tracking-tight">Ingin mengubah pengaturan?</h3>
              <p className="text-blue-100 font-medium max-w-sm">
                Kunjungi dashboard untuk mengatur notifikasi WhatsApp, Telegram, atau sinkronisasi Moodle.
              </p>
            </div>
            <button 
        ...
        <div className="flex items-center justify-center gap-3 text-slate-400 pt-8 border-t border-slate-100">
          ...
          <p className="text-xs font-bold uppercase tracking-widest">Data Anda aman dengan enkripsi AES-256 dan protokol OAuth 2.0</p>
        </div>
      </div>
    </InfoLayout>
  )
