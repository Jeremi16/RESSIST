      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[11px] text-slate-400 pl-1 flex items-center gap-1">
            <AlertCircle className="size-3" /> Tempel URL ekspor kalender
            (format ICS) dari Moodle ITERA.
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 font-medium">
                  Buka bot dan ketik <strong>/id</strong>
                </p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-100 rounded-3xl p-6">
          <div className="flex items-center justify-between gap-6">
            <div className="flex gap-4">
              <div className="size-12 bg-white rounded-2xl shadow-sm flex items-center justify-center text-2xl">
                🌅
              </div>
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium leading-relaxed max-w-[200px]">
                  Ringkasan tugas harian dikirim setiap pukul 07:00 WIB.
                </p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
