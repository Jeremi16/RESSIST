  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <div className="size-10 bg-[#0059D0] text-white rounded-xl flex items-center justify-center shrink-0"><Send className="size-5" /></div>
        ...
        {chatId && (
          <button onClick={handleToggle} disabled={toggling || isLoading} className={cn("relative shrink-0 h-7 w-12 rounded-full transition-colors disabled:opacity-60", optimisticEnabled ? "bg-[#0059D0]" : "bg-black/10")} aria-label={optimisticEnabled ? "Nonaktifkan Telegram" : "Aktifkan Telegram"}>
      ...
      {chatId && (
        <div className={cn("rounded-2xl border px-4 py-3 flex items-center gap-3", optimisticEnabled ? "bg-[#0059D0] text-white border-[#0059D0]" : "bg-[#60A8F8]/10 border-black/5 text-black")}>
