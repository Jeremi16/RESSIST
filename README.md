...
| **mobile-kmp** | Kotlin Multiplatform + Jetpack Compose | `mobile-kmp/` | Sideload APK via GitHub Release (saat ini v0.3.2) |
...
│   ├── androidApp/    # Compose UI (applicationId id.ac.itera.ressist, v0.3.2/code 8)
...
*   Rilis saat ini **v0.3.4 (`versionCode 10`)**, `applicationId id.ac.itera.ressist`.
